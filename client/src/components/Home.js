  ...
  return (
    <div>
      <div className="first">
        <div className="boxx">
          ...
          <div className="dataCard">
            <div className="cards1">
              <div className='text-white text-[35px]'>WeLcome To AuctionAstra !!!</div>
              <h1>
                Build, Sell and <br />
                Earn
              </h1>
        ...
        <div className="bottomHome mt-[30px]"> <Livebidcarousel />
        </div>
        <div className=' flex justify-start items-center'> <div className='text-[25px] font-mono'>Categories Of Auctions</div> </div>
