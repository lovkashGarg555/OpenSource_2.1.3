...
<form action="POST" className='flex flex-col justify-center items-center'>
   ...
   <div>Email : <input onChange={handlechange}  type="text" placeholder='12354@gmail.com' name='Email' /></div>
   <div>AccountNumber : <input onChange={handlechange} type="text" placeholder='****'  name='accountno'/></div>
